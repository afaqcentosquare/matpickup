                ...
                <div class="hero-side-category">
                    ...
                    <div class="category-toggle-wrap">
                        ...
                        <button class="more-btn">
                            <span class="lnr lnr-text-align-left"></span> Bläddra Stad
                        </button>
                    </div>
                    ...
                    <nav class="category-menu">
                        <ul>
                            ...
                            <li><a href="{{route("user.store.products",$store_name->slug)}}">{{$store_name->name}}</a></li>
                            @endforeach
                        </ul>
                    </nav>
                </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="vertical-menu d-none d-lg-block">
                    ...
                    <ul class="vmenu-content">
                        @foreach ($stores as $store_name)
                        <li class="menu-item"><a href="{{route("user.store.products",$store_name->slug)}}">{{$store_name->name}}</a></li>
                        @endforeach
                    </ul>
                    <!-- menu content -->
                </div>
